...
UBUNTU_TRANSLATION_DOMAIN="mapfromitem.liu-xiao-guo"
...
aptest.commands = bash $$PWD/mapfromitem/tests/autopilot/run
aptest.depends  = sub-mapfromitem

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/mapfromitem/tests/unit 
unittest.depends  = sub-mapfromitem
